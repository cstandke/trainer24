  ...
  render() {
    return (
      <div> 
        ...
        <Container>
          <Row className="mt-4">
            <Col md="3" className="bg-primary shadow">
              <img src="https://mobirise.com/extensions/realtym4/assets/images/face4.jpg" alt="Profile Pic" className="img-fluid"/>
            </Col>
            <Col sm="8" className="py-3 px-4 shadow">
              <h2 className="text-primary mt-2">{this.user.firstName} {this.user.lastName}</h2>
